...
CREATE INDEX IF NOT EXISTS idx_set_cards_card_set_id ON set_cards(card_set_id);

-- card_sets
CREATE INDEX IF NOT EXISTS idx_card_sets_set_rarity_id ON card_sets(set_rarity_id);
